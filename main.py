...
def login_page():
    ...
    with col2:
        st.image("attached_assets/Braavos%20Capital%20logo%20white%20bird.png", width=200)
...
def main_dashboard():
    ...
    # Sidebar with logo
    st.sidebar.image("attached_assets/Braavos%20Capital%20logo%20white%20bird.png", width=150)
